...
import { publishVideoLikeEvent } from "../kafka/producers/videoEventsProducer.js";
const isValidObjectId = (id) => mongoose.isValidObjectId(id);

const toggleVideoLike = asyncHandler(async (req, res) => {
  //KAFKA added for notifcation to consumer for video like/unlike event
  ...
  if (existing) {
    ...
    await publishVideoLikeEvent(videoId, req.user._id, "UNLIKED");
  ...
  await publishVideoLikeEvent(videoId, req.user._id, "LIKED");
  return res
    .status(201)
    .json(
