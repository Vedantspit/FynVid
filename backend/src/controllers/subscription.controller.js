...
import { publishSubscriptionEvent } from "../kafka/producers/videoEventsProducer.js";
...
const toggleSubscription = asyncHandler(async (req, res) => {
  ...
  if (existing) {
    ...
    await publishSubscriptionEvent(req.user._id, channelId, "UNSUBSCRIBED");
  ...
  await publishSubscriptionEvent(req.user._id, channelId, "SUBSCRIBED");
